...
export function Footer() {
  ...
  // On chat route, hide marketing footer to give full viewport to the assistant
  if (pathname === "/chat") {
    return null;
  }
  return (
    <footer className="border-t border-[#E8E1D5] bg-[#FAF7F2] text-[#546071] text-xs py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-[#E8E1D5] pt-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] font-medium">
          <p>© {new Date().getFullYear()} PackCraft AI. Engineered for Indian Agro-Food Processors &amp; MSMEs.</p>
          <div className="flex gap-4 font-bold text-[#141928]">
            ...
            <Link href="/chat" className="hover:text-[#2A45FE] transition-colors">AI Assistant</Link>
